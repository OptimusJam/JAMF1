...
--
-- Servidor: localhost
-- Tiempo de generación: 11-02-2014 a las 11:48:39
...
--
-- Estructura de tabla para la tabla `campeones_carrera`
--

DROP TABLE IF EXISTS `campeones_carrera`;
CREATE TABLE IF NOT EXISTS `campeones_carrera` (
  `cam_car_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `cam_car_car_cod` int(10) unsigned NOT NULL,
  `cam_car_usr_nom` varchar(75) COLLATE latin1_spanish_ci NOT NULL,
  `cam_car_pil_1_nom` varchar(45) COLLATE latin1_spanish_ci DEFAULT NULL,
  `cam_car_pil_1_val` int(10) unsigned NOT NULL,
  `cam_car_pil_1_pun` int(10) unsigned NOT NULL,
  `cam_car_pil_2_nom` varchar(45) COLLATE latin1_spanish_ci NOT NULL,
  `cam_car_pil_2_val` int(10) unsigned NOT NULL,
  `cam_car_pil_2_pun` int(10) unsigned NOT NULL,
  `cam_car_pil_3_nom` varchar(45) COLLATE latin1_spanish_ci NOT NULL,
  `cam_car_pil_3_val` int(10) unsigned NOT NULL,
  `cam_car_pil_3_pun` int(10) unsigned NOT NULL,
  `cam_car_pil_4_nom` varchar(45) COLLATE latin1_spanish_ci NOT NULL,
  `cam_car_pil_4_val` int(10) unsigned NOT NULL,
  `cam_car_pil_4_pun` int(10) unsigned NOT NULL,
  `cam_car_esc_1_nom` varchar(45) COLLATE latin1_spanish_ci NOT NULL,
  `cam_car_esc_1_val` int(10) unsigned NOT NULL,
  `cam_car_esc_1_pun` int(10) unsigned NOT NULL,
  `cam_car_esc_2_nom` varchar(45) COLLATE latin1_spanish_ci NOT NULL,
  `cam_car_esc_2_val` int(10) unsigned NOT NULL,
  `cam_car_esc_2_pun` int(10) unsigned NOT NULL,
  `cam_car_mot_1_nom` varchar(45) COLLATE latin1_spanish_ci NOT NULL,
  `cam_car_mot_1_val` int(10) unsigned NOT NULL,
  `cam_car_mot_1_pun` int(10) unsigned NOT NULL,
  `cam_car_cam_cod` int(10) unsigned NOT NULL,
  `cam_car_pun_alo` int(10) unsigned NOT NULL,
  `cam_car_pun_pod` int(10) unsigned NOT NULL,
  PRIMARY KEY (`cam_car_id`)
...
(3, 'Vodafone McLaren Mercedes', 3),
(4, 'Lotus F1 Team', 1),
(5, 'Mercedes AMG Petronas F1 Team', 2),
(6, 'Sauber F1 Team', 3),
(7, 'Sahara Force India F1 Team', 2),
(8, 'Williams F1 Team', 1),
(9, 'Scuderia Toro Rosso', 2),
(10, 'Caterham F1 Team', 1),
(11, 'Marussia F1 Team', 4);
...
(14, 'Paul di Resta', 7),
(15, 'Adrian Sutil', 7),
(16, 'Pastor Maldonado', 8),
(17, 'Valtteri Bottas', 8),
(18, 'Jean-Eric Vergne', 9),
(19, 'Daniel Ricciardo', 9),
(20, 'Charles Pic', 10),
(21, 'Giedo van der Garde', 10),
(22, 'Luiz Razia', 11),
(23, 'Max Chilton', 11);
...
(23, 23, 1, 800, 0.15),
(22, 22, 1, 800, 0.15),
(21, 21, 1, 900, -0.141284403669725),
(20, 20, 1, 1000, 0.128787878787879),
(19, 19, 1, 1100, -0.15),
(18, 18, 1, 1100, -0.15),
(17, 17, 1, 1200, -0.15),
(16, 16, 1, 1600, -0.15),
...
(12, 12, 1, 1800, -0.15),
(11, 11, 1, 2100, -0.15),
(10, 10, 1, 3100, 0.0752104262829216),
(9, 9, 1, 2500, 0.15),
(8, 8, 1, 2300, 0.15),
(7, 7, 1, 2900, 0.15),
(6, 6, 1, 2300, 0.15),
(5, 5, 1, 3300, -0.15),
(4, 4, 1, 2700, 0.15),
(3, 3, 1, 3500, 0.0669745958429562),
(2, 2, 1, 3100, 0.15),
(1, 1, 1, 3700, -0.08994708994709),
(2254, 23, 2, 920, 0.15),
(2253, 22, 2, 920, 0.15),
(2252, 21, 2, 773, 0.15),
(2251, 20, 2, 1129, 0.0596491228070175),
(2250, 19, 2, 935, -0.15),
(2249, 18, 2, 935, 0.15),
(2248, 17, 2, 1020, 0.0608424336973479),
(2247, 16, 2, 1360, -0.15),
(2246, 15, 2, 1955, -0.15),
(2245, 14, 2, 2185, -0.15),
(2244, 12, 2, 1530, -0.15),
...
(2235, 3, 2, 3734, -0.15),
(2234, 2, 2, 3565, 0.15),
(2233, 1, 2, 3367, 0.098901098901099),
(2276, 23, 3, 1058, 0.15),
(2275, 22, 3, 1058, -0.119266055045872),
(2274, 21, 3, 889, -0.15),
(2273, 20, 3, 1196, -0.107266435986159),
(2272, 19, 3, 795, 0.15),
(2271, 18, 3, 1075, 0.0956521739130434),
(2270, 17, 3, 1082, 0.0909090909090908),
(2269, 16, 3, 1156, 0.15),
(2268, 15, 3, 1662, -0.15),
(2267, 14, 3, 1857, 0.15),
(2266, 12, 3, 1300, -0.15),
...
(2261, 7, 3, 2835, 0.15),
(2260, 6, 3, 3042, 0.15),
(2259, 5, 3, 2384, 0.110682607018897),
(2258, 4, 3, 3571, 0.032258064516129),
(2257, 3, 3, 3174, 0.15),
(2256, 2, 3, 4100, -0.15),
(2255, 1, 3, 3700, -0.15),
(2298, 23, 4, 1217, -0.15),
...
(2290, 15, 4, 1413, -0.15),
(2289, 14, 4, 2136, 0.15),
(2288, 12, 4, 1105, -0.0557620817843866),
(2287, 11, 4, 1745, -0.15),
(2286, 10, 4, 4408, -0.15),
(2285, 9, 4, 3802, 0.15),
(2284, 8, 4, 3498, 0.15),
...
(2281, 5, 4, 2648, -0.15),
(2280, 4, 4, 3686, -0.15),
(2279, 3, 4, 3650, 0.0604870384917517),
(2278, 2, 4, 3485, -0.15),
(2277, 1, 4, 3145, 0.15),
(2320, 23, 5, 1034, -0.0782608695652174),
(2319, 22, 5, 792, -0.124744376278119),
(2318, 21, 5, 700, -0.15),
(2317, 20, 5, 908, 0.0474383301707779),
(2316, 19, 5, 1051, 0.15),
(2315, 18, 5, 1001, -0.15),
(2314, 17, 5, 1357, -0.15),
(2313, 16, 5, 1528, 0.15),
...
(2305, 7, 5, 3749, 0.15),
(2304, 6, 5, 4023, 0.15),
(2303, 5, 5, 2251, 0.0191082802547771),
(2302, 4, 5, 3133, 0.15),
(2301, 3, 5, 3871, 0.15),
(2300, 2, 5, 2962, 0.137476459510358),
(2299, 1, 5, 3617, 0.137662337662338),
(2342, 23, 6, 953, 0.15),
(2341, 22, 6, 700, -0.15),
(2340, 21, 6, 700, -0.00552486187845302),
(2339, 20, 6, 951, -0.15),
(2338, 19, 6, 1209, -0.15),
(2337, 18, 6, 851, 0.15),
(2336, 17, 6, 1153, -0.0393374741200828),
(2335, 16, 6, 1757, -0.15),
(2334, 15, 6, 1021, 0.15),
(2333, 14, 6, 2824, 0.0501193317422435),
(2332, 12, 6, 1199, 0.15),
(2331, 11, 6, 1261, -0.15),
(2330, 10, 6, 3185, 0.15),
(2329, 9, 6, 5028, 0.15),
...
(2325, 5, 6, 2294, 0.15),
(2324, 4, 6, 3603, -0.15),
(2323, 3, 6, 4452, -0.0503956684714703),
(2322, 2, 6, 3369, 0.15),
(2321, 1, 6, 4115, 0.15),
(2364, 23, 7, 1096, 0.15),
(2363, 22, 7, 700, 0.133858267716535),
(2362, 21, 7, 700, -0.15),
(2361, 20, 7, 808, -0.0113636363636364),
(2360, 19, 7, 1028, -0.15),
(2359, 18, 7, 979, 0.15),
(2358, 17, 7, 1108, 0.15),
(2357, 16, 7, 1493, -0.15),
(2356, 15, 7, 1174, 0.15),
(2355, 14, 7, 2966, -0.0267639902676399),
(2354, 12, 7, 1379, -0.15),
(2353, 11, 7, 1072, -0.15),
(2352, 10, 7, 3663, 0.15),
(2351, 9, 7, 5782, 0.15),
...
(2347, 5, 7, 2638, -0.15),
(2346, 4, 7, 3063, -0.15),
(2345, 3, 7, 4228, 0.134860050890585),
(2344, 2, 7, 3874, 0.15),
(2343, 1, 7, 4732, 0.15),
(2386, 23, 8, 1260, 0.00854700854700852),
(2385, 22, 8, 794, 0.15),
(2384, 21, 8, 700, 0.15),
(2383, 20, 8, 799, 0.15),
(2382, 19, 8, 874, 0.15),
...
(2373, 9, 8, 6649, 0.15),
(2372, 8, 8, 2471, -0.15),
(2371, 7, 8, 3114, -0.0187393526405452),
(2370, 6, 8, 3342, -0.15),
(2369, 5, 8, 2242, -0.15),
(2368, 4, 8, 2604, 0.15),
(2367, 3, 8, 4798, 0.0151724137931035),
(2366, 2, 8, 4455, 0.15),
(2365, 1, 8, 5442, -0.15),
(2408, 23, 9, 1271, 0.124236252545825),
(2407, 22, 9, 913, 0.15),
(2406, 21, 9, 805, 0.15),
(2405, 20, 9, 919, 0.15),
(2404, 19, 9, 1005, 0.15),
...
(2391, 5, 9, 1906, 0.15),
(2390, 4, 9, 2995, 0.15),
(2389, 3, 9, 4871, -0.147286821705426),
(2388, 2, 9, 5123, 0.15),
(2387, 1, 9, 4626, 0.105193075898802),
(2430, 23, 10, 1429, -0.15),
(2429, 22, 10, 1050, -0.023728813559322),
(2428, 21, 10, 926, 0.15),
(2427, 20, 10, 1057, -0.15),
(2426, 19, 10, 1156, 0.15),
(2425, 18, 10, 813, -0.15),
(2424, 17, 10, 1245, -0.15),
(2423, 16, 10, 1678, 0.15),
(2422, 15, 10, 1319, -0.15),
(2421, 14, 10, 2086, -0.15),
(2420, 12, 10, 847, 0.15),
(2419, 11, 10, 1205, -0.137662337662338),
(2418, 10, 10, 5571, 0.15),
(2417, 9, 10, 6499, -0.0524781341107872),
(2416, 8, 10, 2415, 0.15),
(2415, 7, 10, 3514, -0.15),
(2414, 6, 10, 3267, 0.15),
(2413, 5, 10, 2192, 0.15),
(2412, 4, 10, 3444, 0.15),
(2411, 3, 10, 4154, 0.15),
(2410, 2, 10, 5891, 0.0659488559892329),
(2409, 1, 10, 5113, 0.15),
(2452, 23, 11, 1215, -0.00709219858156029),
(2451, 22, 11, 1025, -0.0319634703196348),
(2450, 21, 11, 1065, -0.0177215189873418),
(2449, 20, 11, 898, 0.15),
(2448, 19, 11, 1329, 0.15),
(2447, 18, 11, 700, -0.15),
(2446, 17, 11, 1058, -0.15),
(2445, 16, 11, 1930, -0.15),
(2444, 15, 11, 1121, -0.15),
(2443, 14, 11, 1773, -0.15),
(2442, 12, 11, 974, 0.15),
(2441, 11, 11, 1039, 0.15),
(2440, 10, 11, 6407, -0.15),
(2439, 9, 11, 6158, -0.15),
(2438, 8, 11, 2777, 0.139137510170871),
(2437, 7, 11, 2987, -0.15),
(2436, 6, 11, 3757, 0.15),
(2435, 5, 11, 2521, 0.15),
(2434, 4, 11, 3961, 0.15),
(2433, 3, 11, 4777, 0.15),
(2432, 2, 11, 6280, 0.0686695278969958),
(2431, 1, 11, 5880, 0.15),
(2453, 1, 12, 6762, 0.15),
(2454, 2, 12, 6711, -0.15),
(2455, 3, 12, 5494, 0.104325699745547),
(2456, 4, 12, 4555, 0.15),
(2457, 5, 12, 2899, 0.15),
(2458, 6, 12, 4321, 0.15),
(2459, 7, 12, 2539, 0.15),
(2460, 8, 12, 3163, -0.15),
(2461, 9, 12, 5234, 0.15),
(2462, 10, 12, 5446, -0.15),
(2463, 11, 12, 1195, 0.15),
(2464, 12, 12, 1120, 0.15),
(2465, 14, 12, 1507, -0.15),
(2466, 15, 12, 953, 0.095290251916758),
(2467, 16, 12, 1640, 0.15),
(2468, 17, 12, 899, 0.15),
(2469, 18, 12, 700, 0.15),
(2470, 19, 12, 1528, -0.15),
(2471, 20, 12, 1033, 0.15),
(2472, 21, 12, 1046, 0.136563876651982),
(2473, 22, 12, 992, 0.073394495412844),
(2474, 23, 12, 1206, 0.15),
(2475, 1, 13, 7776, 0.15),
(2476, 2, 13, 5704, -0.15),
(2477, 3, 13, 6067, -0.15),
(2478, 4, 13, 5238, -0.120643431635389),
(2479, 5, 13, 3334, -0.0503597122302159),
(2480, 6, 13, 4969, 0.15),
(2481, 7, 13, 2920, 0.15),
(2482, 8, 13, 2689, 0.15),
(2483, 9, 13, 6019, 0.15),
(2484, 10, 13, 4629, -0.00120627261761153),
(2485, 11, 13, 1374, 0.15),
(2486, 12, 13, 1288, 0.15),
(2487, 14, 13, 1281, -0.15),
(2488, 15, 13, 1044, -0.15),
(2489, 16, 13, 1886, -0.0450751252086812),
(2490, 17, 13, 1034, 0.15),
(2491, 18, 13, 805, -0.0994152046783626),
(2492, 19, 13, 1299, -0.15),
(2493, 20, 13, 1188, 0.15),
(2494, 21, 13, 1189, 0.15),
(2495, 22, 13, 1065, 0.15),
(2496, 23, 13, 1387, 0.132743362831858),
(2541, 1, 14, 8942, -0.129657228017884),
(2542, 2, 14, 4848, 0.15),
(2543, 3, 14, 5157, -0.15),
(2544, 4, 14, 4606, -0.15),
(2545, 5, 14, 3166, -0.15),
...
(2548, 8, 14, 3092, 0.15),
(2549, 9, 14, 6922, -0.15),
(2550, 10, 14, 4623, -0.15),
(2551, 11, 14, 1580, 0.15),
(2552, 12, 14, 1481, 0.15),
(2553, 14, 14, 1089, 0.15),
(2554, 15, 14, 887, 0),
(2555, 16, 14, 1801, -0.15),
(2556, 17, 14, 1189, -0.15),
(2557, 18, 14, 725, 0.15),
(2558, 19, 14, 1104, -0.15),
(2559, 20, 14, 1366, 0.15),
(2560, 21, 14, 1367, -0.15),
(2561, 22, 14, 1225, -0.15),
(2562, 23, 14, 1571, -0.15),
(2585, 1, 15, 7783, -0.0712074303405573),
(2586, 2, 15, 5575, -0.15),
(2587, 3, 15, 4383, -0.15),
(2588, 4, 15, 3915, 0.15),
(2589, 5, 15, 2691, -0.15),
...
(2592, 8, 15, 3556, 0.15),
(2593, 9, 15, 5884, 0.15),
(2594, 10, 15, 3930, 0.15),
(2595, 11, 15, 1817, -0.15),
(2596, 12, 15, 1703, -0.033816425120773),
(2597, 14, 15, 1252, 0.15),
(2598, 15, 15, 887, 0.15),
(2599, 16, 15, 1531, 0.15),
(2600, 17, 15, 1011, -0.15),
(2601, 18, 15, 834, 0.15),
(2602, 19, 15, 938, 0.15),
(2603, 20, 15, 1571, -0.0260869565217391),
(2604, 21, 15, 1162, -0.15),
(2605, 22, 15, 1041, 0.0572207084468666),
(2606, 23, 15, 1335, 0.15),
(2629, 1, 16, 7229, -0.0959752321981424),
(2630, 2, 16, 4739, 0.15),
(2631, 3, 16, 3726, 0.15),
(2632, 4, 16, 4502, 0.15),
(2633, 5, 16, 2287, -0.15),
...
(2636, 8, 16, 4089, 0.15),
(2637, 9, 16, 6767, 0.15),
(2638, 10, 16, 4520, 0.15),
(2639, 11, 16, 1544, -0.15),
(2640, 12, 16, 1645, -0.15),
(2641, 14, 16, 1440, 0.15),
(2642, 15, 16, 1020, 0.15),
(2643, 16, 16, 1761, -0.0596745027124774),
(2644, 17, 16, 859, -0.144893111638955),
(2645, 18, 16, 959, -0.105263157894737),
(2646, 19, 16, 1079, 0.134328358208955),
(2647, 20, 16, 1530, -0.15),
(2648, 21, 16, 988, 0.0481927710843373),
(2649, 22, 16, 1101, 0.0614525139664805),
(2650, 23, 16, 1535, -0.15),
(2673, 1, 17, 6535, 0.13452188006483),
(2674, 2, 17, 5450, 0.15),
(2675, 3, 17, 4285, 0.15),
(2676, 4, 17, 5177, -0.15),
(2677, 5, 17, 1944, 0.15),
...
(2680, 8, 17, 4702, 0.15),
(2681, 9, 17, 7782, -0.15),
(2682, 10, 17, 5198, 0.15),
(2683, 11, 17, 1312, 0.15),
(2684, 12, 17, 1398, -0.15),
(2685, 14, 17, 1656, -0.15),
(2686, 15, 17, 1173, -0.15),
(2687, 16, 17, 1656, -0.15),
(2688, 17, 17, 735, 0.15),
(2689, 18, 17, 858, -0.15),
(2690, 19, 17, 1224, 0.00401606425702816),
(2691, 20, 17, 1300, 0.00478468899521522),
(2692, 21, 17, 1036, 0.117241379310345),
(2693, 22, 17, 1169, 0.15),
(2694, 23, 17, 1305, -0.15),
(2717, 1, 18, 7414, 0),
(2718, 2, 18, 6268, 0),
(2719, 3, 18, 4928, 0),
(2720, 4, 18, 4400, 0),
